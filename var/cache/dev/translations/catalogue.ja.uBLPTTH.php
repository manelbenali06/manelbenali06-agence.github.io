...
$catalogue = new MessageCatalogue('ja', array (
  ...
  array (
    ...
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'このパスワードは、侵害されたパスワードのデータベースで見つかりました。 {{used}}回使用されています。セキュリティ上の理由から、別のものを使用する必要があります。',
  ),
  'security' => 
  array (
