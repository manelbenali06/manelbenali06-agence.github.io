...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Toto heslo bylo nalezeno v databázi ohrožených hesel. Byl používán {{used}} časy. Z bezpečnostních důvodů musíte použít něco jiného.    ',
  ),
  'security' => 
  array (
