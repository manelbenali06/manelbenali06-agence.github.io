...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Этот пароль был найден в базе данных с взломанными паролями. Он использовался {{used}} раз. В целях безопасности вы должны использовать что-то еще.',
  ),
  'security' => 
  array (
