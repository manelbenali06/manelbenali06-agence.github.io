...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    ...
    'password_too_weak' => 'Wachtwoord moet ten minste aan veiligheidsniveau "{{ min_strength }}" voldoen, maar het huidige niveau is "{{ current_strength }}". Probeer het volgende: {{ strength_tips }}.',
    ...
    'rollerworks_password.tip.numbers' => 'voeg cijfers toe',
    ...
    'rollerworks_password.tip.special_chars' => 'voeg speciale tekens of leestekens toe',
