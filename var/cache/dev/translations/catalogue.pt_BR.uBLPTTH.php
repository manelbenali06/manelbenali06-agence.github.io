...
$catalogue = new MessageCatalogue('pt_BR', array (
  ...
  array (
    ...
    'Your password must contain at least one special character.' => 'A senha deve conter pelo menos um caractere especial.',
    'password_too_weak' => 'A senha deve ter pelo menos o nível de intensidade "{{ min_strength }}" e o nível atual é "{{ current_strength }}". Tente o seguinte: {{ strength_tips }}.',
    ...
    'rollerworks_password.tip.uppercase_letters' => 'adicionar letras maiúsculas',
    'rollerworks_password.tip.special_chars' => 'adicionar caracteres especiais',
    'rollerworks_password.tip.length' => 'adicionar mais caracteres',
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Esta senha foi encontrada em um banco de dados de senhas comprometidas. Foi usada {{used}} vezes. Por motivos de segurança, você deve usar outra senha.',
  ),
  'security' => 
  array (
