...
$catalogue = new MessageCatalogue('it', array (
  ...
  array (
    ...
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Questa password è stata trovata in un database di password compromesse. È stato usato {{used}} volte. Per motivi di sicurezza devi usare qualcos\'altro.',
  ),
  'security' => 
  array (
