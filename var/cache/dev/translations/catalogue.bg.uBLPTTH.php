...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Тази парола бе намерена в база данни с компрометирани пароли. Използва се {{used}} пъти. За целите на сигурността трябва да използвате нещо друго.',
  ),
  'security' => 
  array (
