...
$catalogue = new MessageCatalogue('pl', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Hasło musi składać się z przynajmniej {{length}} znaków.',
    'Your password must include at least one letter.' => 'Hasło musi zawierać przynajmniej jedną literę.',
    'Your password must include both upper and lower case letters.' => 'Hasło musi zawierać duże i małe litery.',
    'Your password must include at least one number.' => 'Hasło musi zawierać przynajmniej jedną cyfrę.',
    'Your password must contain at least one special character.' => 'Hasło musi zawierać przynajmniej jeden znak specjalny.',
    'password_too_weak' => 'Hasło musi być przynajmniej "{{ min_strength }}". Obecny poziom siły hasła to "{{ current_strength }}", spróbuj: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Bardzo słabe',
    'rollerworks_password.strength_level.weak' => 'Słabe',
    'rollerworks_password.strength_level.medium' => 'Średnie',
    'rollerworks_password.strength_level.strong' => 'Silne',
    'rollerworks_password.strength_level.very_strong' => 'Bardzo silne',
    'rollerworks_password.tip.letters' => 'dodać (małe/duże) litery',
    'rollerworks_password.tip.numbers' => 'dodać cyfry',
    'rollerworks_password.tip.lowercase_letters' => 'dodać małe litery',
    'rollerworks_password.tip.uppercase_letters' => 'dodać duże litery',
    'rollerworks_password.tip.special_chars' => 'dodać znaki specjalne',
    'rollerworks_password.tip.length' => 'dodać więcej znaków',
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'To hasło zostało znalezione w bazie skompromitowanych haseł. Zostało użyte {{ used }} razy. Ze względów bezpieczeństwa musisz użyć innego hasła.',
  ),
  'security' => 
  array (
